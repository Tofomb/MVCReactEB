...
namespace MVCReactEB.Controllers
{
    ...
    public class ScoresController : Controller
    {
        ...
        public ScoresController(MVCReactEBContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Scores/5
        [HttpGet("{id}")]
        public async Task<IActionResult> GetScore([FromRoute] string id)
        {
        ...
        // PUT: api/Scores/5
        [HttpPut("{id}")]
        public async Task<IActionResult> PutScore([FromRoute] string id, [FromBody] Score score)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
